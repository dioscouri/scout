	...
	<table class="adminlist" style="clear: both;">
		<thead>
            <tr>
                ...
                <th style="width: 50px;">
                	<?php echo DSCGrid::sort( 'ID', "tbl.verb_id", @$state->direction, @$state->order ); ?>
                </th>                
                <th style="text-align: left;">
                	<?php echo DSCGrid::sort( 'Name', "tbl.verb_name", @$state->direction, @$state->order ); ?>
                </th>
                <th style="width: 100px;">
    	            <?php echo DSCGrid::sort( 'Value', "tbl.verb_value", @$state->direction, @$state->order ); ?>
                </th>
            </tr>
            <tr class="filterline">
               <th colspan="3">
        ...
        <?php foreach (@$items as $item) : ?>
            <tr class='row<?php echo $k; ?>'>
				...
				<td style="text-align: center;">
					<?php echo DSCGrid::checkedout( $item, $i, 'verb_id' ); ?>
				</td>
				<td style="text-align: center;">
