...
class ScoutReportPlugin extends ScoutPluginBase
{
    /**
    ...
    function _getNamespace()
    {
        ...
        $ns = $app->getName().'::'.'com.scout.report.'.$this->get('_element');
        return $ns;
    }
     ...
     * @return array
     */
    function _getModel( $name = '', $prefix = 'ScoutModel', $config = array() )
    {
    	if (empty( $name ))
    	{
