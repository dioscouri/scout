...
JLoader::import( 'com_scout.library.plugins._base', JPATH_ADMINISTRATOR.DS.'components' );

class ScoutPaymentPlugin extends ScoutPluginBase 
{
    /**
     ...
     * index.php?option=com_scout&view=checkout&task=confirmPayment&orderpayment_type=xxxxxx
    ...
    {
	    JLoader::import( 'com_scout.helpers.carts', JPATH_ADMINISTRATOR.DS.'components' );
	    ScoutHelperCarts::removeOrderItems( $order_id );
    }
