     ...
     * This should be renamed to scoutResetFormFilters
     * 
     * @param form
     * @return
     */
    function scoutFormReset(form)
    {
	 ...
	 * @param {Object} task
	 */
	function scoutGridOrdering( order, dir ) 
	{
	 ...
	 * @return
	 */
	function scoutGridOrder(id, change) 
	{
		var form = document.adminForm;
     ...
     */
    function scoutFormValidation( url, container, task, form ) 
    {
	 ...
	 */
	function scoutDisplayDiv (divname, spanname, showtext, hidetext) { 
	 ...
	 */
	function scoutSwitchDisplayDiv( prefix, newSuffix )
	{
	...
	function scoutShowHideDiv(divname)
	{
	 ...
	 */
	function scoutDoTask( url, container, form, msg ) 
	{
		scoutNewModal(msg);
		...
		{	
            ...
            var a=new Ajax(url,{
                ...
                onComplete: function(response){
                    ...
                    (function() { document.body.removeChild($('scoutModal')); }).delay(500);
                    return true;
                }
            }).request();
		}
	...
	function scoutNewModal (msg)
	{
		...
		var src = 'media/com_scout/images/ajax-loader.gif';
	 ...
	 * @return string
	 */
	function scoutGetCheckedValue(radioObj) 
	{
	    if (!radioObj) { return ""; }
